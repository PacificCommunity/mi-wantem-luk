...
# pp  <- read.MFCLPar('/home/rob/MSE/ofp-sam-albacore_MSE/OMs/CC_grid/run29/06.par')
# tpo <- read.MFCLLikelihood('/home/rob/MSE/ofp-sam-albacore_MSE/OMs/CC_grid/run29/test_plot_output')
# lfit<- read.MFCLLenFit2('/home/rob/MSE/ofp-sam-albacore_MSE/OMs/CC_grid/run29/length.fit')
# lenCompFits(lfit, pp, tpo, fsh=15, years=2010:2019)
